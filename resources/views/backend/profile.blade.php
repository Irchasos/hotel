...
<h2>User data</h2>
<form {{ $novalidate /* Lecture 39 */ }} action="{{ route('profile') /* Lecture 39 */ }}" method="POST"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input name="name" type="text" required class="form-control" id="name"
                       value="{{ $user->name /* Lecture 39 */ }}">
            </div>
        </div>
        <div class="form-group">
            <label for="surname" class="col-lg-2 control-label">Last name *</label>
            <div class="col-lg-10">
                <input name="surname" type="text" required class="form-control" id="surname"
                       value="{{ $user->surname /* Lecture 39 */ }}">
            </div>
        </div>
        <div class="form-group">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <img class="img-responsive"
                             src="{{ $user->photos->first()->path ?? $placeholder /* Lecture 39 */ }}" alt="...">
                        <div class="caption">
                            <p><a href="{{ route('deletePhoto',['id'=>$user->photos->first()->id]) /* Lecture 39 */ }}"
