    ...
    <form method="POST" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input name="room_number" required type="number" class="form-control" id="roomNumber"
                           placeholder="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input name="room_size" required type="number" class="form-control" id="peopleNumber"
                           placeholder="">
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <img class="img-responsive"
                                 src="http://lorempixel.com/275/150/city/?x=<?php echo mt_rand(1, 9999999) ?>"
                                 alt="...">
                            <div class="caption">
