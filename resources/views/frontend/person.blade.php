                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 top-buffer">
                                <button class="btn btn-success btn-block"><span
                                        class="fa fa-plus-circle"></span> {{ $user->objects->count()  }} liked objects
                                </button>
                                <ul class="list-group">
                            ...
                            <div class="col-sm-12">
                                <button class="btn btn-info btn-block"><span
                                        class="fa fa-user"></span> {{ $user->larticles->count()  }} liked articles
                                </button>
                                <ul class="list-group">
                            ...
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-primary btn-block"><span
                                        class="fa fa-gear"></span> {{ $user->comments->count()  }} Comments
                                </button>
                                <ul class="list-group">
