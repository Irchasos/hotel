                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-3">
                                <img src="{{ $user->photos->first()->path ?? $placeholder  }}" alt=""
                            ...
                            <div class="col-sm-12 top-buffer">
                                <button class="btn btn-success btn-block"><span
                                        class="fa fa-plus-circle"></span> {{ $user->objects->count()  }} {{ __('mainpage.likedby') }}
                                </button>
                                <ul class="list-group">
                            ...
                            <div class="col-sm-12">
                                <button class="btn btn-info btn-block"><span
                                        class="fa fa-user"></span> {{ $user->larticles->count()  }} {{ __('mainpage.likedby') }}
                                </button>
                                <ul class="list-group">
                            ...
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-primary btn-block"><span
                                        class="fa fa-gear"></span> {{ $user->comments->count()  }} {{ __('mainpage.Commentedby') }}
                                </button>
                                <ul class="list-group">
